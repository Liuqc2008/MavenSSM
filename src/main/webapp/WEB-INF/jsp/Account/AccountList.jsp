        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                layer.confirm('确定删除该行？', function (index) {
                    $.Ajax("/MavenSSM/Account/Delete?id=" + data.id, {}, function (result) {
                        layer.alert("删除成功！");
                        Reload();
                        layer.close(index);
                    });
            	...
            	OpenFrame("修改用户信息", "/MavenSSM/Account/AccountDetail?id=" + data.id, 460, 250, '', Reload);
            }
        });
  		...
  		var $ = layui.$, active = {
			...
			Add: function () {
	         	OpenFrame("新增用户", "/MavenSSM/Account/AccountDetail", 460, 250, '', Reload);
	        },	
  			reload: function(){
