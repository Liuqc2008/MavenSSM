...
import com.how2java.service.PaymentService;

import apiclient.alipay.page.pay.AliPagePayApi;
...
public class PaymentServiceImpl implements PaymentService{
	...
	public void aliPagePayRefund(Map<String, String> param) throws Exception{
		...
		AliPagePayApi.aliPageRefund(param.get("out_trade_no"), "", param.get("refundAmount"), param.get("refundReason"), param.get("out_trade_no"));
	}
